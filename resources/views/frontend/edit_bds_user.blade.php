                    ...
                    <div class="row map-content-9">
                        <div class="col-lg-9">
                            <div class="contact-form">
                                ...
                                @csrf
                                <form id="frm_edit_bds" name="frm_edit_bds" class="dropzone" action="{{ route('edit_estate_user') }}" method="post" enctype="multipart/form-data" role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control money" name="txt_loaitin" id="txt_loaitin" disabled>
                                                    <option value="20000" {{ $bds->id_LoaiTin=="20000" ? 'selected' : '' }}>Tin thường</option>
                                                    <option value="50000" {{ $bds->id_LoaiTin=="50000" ? 'selected' : '' }}>Tin VIP</option>
                                                </select>
                                                <div id="show_error"></div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" readonly class="form-control money" id="txt_ngaybatdau" name="txt_ngaybatdau" 
                                                value="{{ $bds->NgayBatDau }}"
                                                >
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" readonly class="form-control money" id="txt_ngayketthuc" name="txt_ngayketthuc" 
                                                value="{{ $bds->NgayKetThuc }}"
                                                >
            ...
            init: function(){
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        {
                            var txt_id_bds = result[0].txt_id_bds;
                            $("#txt_id_bds").val(txt_id_bds); // inseting userid into hidden input field
                            toastr.success('Chỉnh sửa tin đăng thành công!','Thông báo');
