...
@section('content')
    ...
    <section class="bds-breadcrumb">
        <div class="container">
            <ul class="breadcrumbs-custom-path">
                ...
                <li class="active"><span class="fa fa-angle-right mx-2" aria-hidden="true"></span> Về chúng tôi</li>
            </ul>
        </div>
    </section>
    <section class="bds-index3" id="about">
        <div class="midd-w3 py-5">
            <div class="container py-lg-5 py-md-4 py-2">
                <div class="row">
                    <div class="col-lg-5 pr-lg-0">
                        <div class="bds-left-img2">
                        </div>
                    </div>
                    <div class="col-lg-7 pl-lg-0">
                        <div class="bds-right-info">
                            <h6 class="title-small">Giới thiệu</h6>
                            <h3 class="title-big">Our long-standing experience</h3>
                            <h5 class="mt-4">We have over 15 year experience, Over 20,000 people work for us in more than 70 countries all over the world. Lorem ipsum viverra feugiat dolor sit amet.
                            </h5>
                            <p class="mt-4">Viverra feugiat. Pellen tesque libero ut justo, ultrices in ligula. Semper at tempufddfel lorem ipsum. Lorem ipsum viverra feugiat dolor sit amet primis in faucibus orci.</p>
        ...
        <!-- <section class="bds-aboutblock2" id="why">
            <div class="midd-w3 py-5">
                <div class="container py-lg-5 py-md-4 py-2">
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-lg-0 mt-5 align-self">
                            ...
                            <p class="mt-4">We have over 15 year experience in business consulting arena. Learn more about our work! Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices in ligula. Semper at tempufddfel
                            </p>
                            <ul class="bds-right-book mt-lg-5 mt-4">
        ...
        <div class="bds-agentsblock py-5" id="team">
            <div class="container py-lg-5 py-md-4 py-2">
    ...
    <!-- stats -->
    <section class="bds-stats py-5" id="stats">
